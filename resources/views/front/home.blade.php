...
@section('content')
                ...
                <div class="row pb-3">
                    @foreach (getCategory() as $cate)
                        <div class="col-lg-3">
                            <div class="cat-card">
                                <div class="left">
                                    <img src="{{ asset('uploads/category_img/' . $cate->image) }}" alt=""
                                        class="img-fluid">
                                </div>
                                <div class="right">
                                    <div class="cat-data">
    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            @if ($feature_product->isNotEmpty())
                <div class="row pb-3">
                    @foreach ($feature_product as $product)
                        @php
                            $image = $product->product_img->first();
                        @endphp
                        <div class="col-md-3">
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="{{ $product->slug }}">{{ $product->title }}</a>
